...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		if !utils.Config.Frontend.OnlyAPI {
			...
			frontEndRouter := router.PathPrefix("/explorer").Subrouter()
			...
			frontEndRouter.HandleFunc("/block/{slotOrHash}/votes", handlers.BlockVoteData).Methods("GET")
			...
			frontEndRouter.HandleFunc("/charts/{chart}", handlers.Chart).Methods("GET")
			...
			frontEndRouter.HandleFunc("/validator/{index}/sync", handlers.ValidatorSync).Methods("GET")
			frontEndRouter.HandleFunc("/validator/{index}/history", handlers.ValidatorHistory).Methods("GET")
			...
			frontEndRouter.HandleFunc("/validator/{index}/effectiveness", handlers.ValidatorAttestationInclusionEffectiveness).Methods("GET")
			...
			frontEndRouter.HandleFunc("/validator/{index}/stats", handlers.ValidatorStatsTable).Methods("GET")
			...
			frontEndRouter.HandleFunc("/validators/streakleaderboard", handlers.ValidatorsStreakLeaderboard).Methods("GET")
			frontEndRouter.HandleFunc("/validators/streakleaderboard/data", handlers.ValidatorsStreakLeaderboardData).Methods("GET")
			...
			frontEndRouter.HandleFunc("/dashboard/data/proposalshistory", handlers.DashboardDataProposalsHistory).Methods("GET")
			frontEndRouter.HandleFunc("/dashboard/data/validators", handlers.DashboardDataValidators).Methods("GET")
			frontEndRouter.HandleFunc("/dashboard/data/effectiveness", handlers.DashboardDataEffectiveness).Methods("GET")
			...
			frontEndRouter.PathPrefix("/").Handler(http.FileServer(http.Dir("static")))
